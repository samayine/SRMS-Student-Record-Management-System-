      ...
      <PageLayout userName="Abebe" pageTitle="Performance">
        <div className="bg-white p-6 shadow-md rounded-lg">
          <h1 className="text-xl font-semibold mb-4">
            Your<strong> Child's</strong> Weekly Performance Report
          </h1>
          <p className="mb-4">
            This week's performance compared to last semester's progress:
          </p>

          <h3 className="text-lg font-semibold">Classroom Engagement:</h3>
          <p className="text-gray-700 mb-4">
            The students have shown improved engagement, with active
            participation in class discussions and increased attendance. There
            has been a 15% increase in participation compared to last semester.
          </p>
          ...
          <p className="text-gray-700">
            ...
            targeted assistance to those needing additional support in [subject
            area].
          </p>
        </div>
      </PageLayout>
